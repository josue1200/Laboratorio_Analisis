...
<%
      ...
      String usuario = (String) actual.getAttribute("Dentro");
            String jerarquia = (String) actual.getAttribute("j");
             ...
             Integer nuevo=(Integer)request.getAttribute("newid");
             //Integer nuevo=12;
    ...
    <body>
        ...
        <form action="sr_Maesto_VentasDetalle" method="POST" class="form-group">
             ...
             <label for="text">ID Ventas</label>
              <input type="text" class="form-control" placeholder="ID" id="txt_id_ventas" name="txt_id_ventas" value=<%=nuevo%> readonly>
 ...
 <table class="table table-hover">
    ...
    <tbody id="tbl_pr">
        <%
           Maestro_VentasDetalle ventadetalle=new Maestro_VentasDetalle();
            ...
            tabladetalle=ventadetalle.TablaDeProductos(nuevo);
            for (int i = 0; i < tabladetalle.getRowCount(); i++) {
                         out.println("<tr data-idmd="+tabladetalle.getValueAt(i, 0)+" data-idvd="+tabladetalle.getValueAt(i, 1)+" data-idp="+tabladetalle.getValueAt(i, 2)+">"); 
  ...
  <script type="text/javascript">
        $('#tbl_pr').on('click','tr td',function(e){
            var target,idvd,idv,idp,cantidad,precio;
            target=$(event.target);
