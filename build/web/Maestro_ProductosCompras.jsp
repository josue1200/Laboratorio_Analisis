<%-- 
    Document   : Maestro_ProductosCompras
    Created on : 1/11/2020, 11:26:42 PM
...
<%
      ...
      String usuario = (String) actual.getAttribute("Dentro");
            String jerarquia = (String) actual.getAttribute("j");
             ...
             Integer nuevo=(Integer)request.getAttribute("nuevo");
            //Integer nuevo=1;
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <form action="sr_Maestro_ComprasDetalle" method="POST" class="form-group">
             ...
             <label for="text">ID Compras</label>
              <input type="text" class="form-control" placeholder="ID" id="txt_idcompra" name="txt_idcompra" value=<%=nuevo%> readonly>
    <label for="text">ID Maestro Detalle:</label>
    <input type="text" class="form-control" placeholder="ID" id="txt_id_mcd" name="txt_id_mcd" value="0" readonly>
    ...
    <input type="decimal"  name="txt_pu" id="txt_pu" class="form-control" >
<button name="boton_agregar" id="boton_agregar" value="agregar" class="btn btn-success">Agregar</button>
<button name="boton_finalizar" id="boton_finalizar" value="terminar" class="btn btn-success">Finalizar</button>
 ...
 <table class="table table-hover">
    ...
    <tbody id="tbl_pr">
        <%
           Maestro_ComprasDetalle ComprasDetalle=new Maestro_ComprasDetalle();
            ...
            tabladetalle=ComprasDetalle.TablaDeProductos(nuevo);
            for (int i = 0; i < tabladetalle.getRowCount(); i++) {
                         out.println("<tr data-idp="+tabladetalle.getValueAt(i, 0)+"  data-idcd="+tabladetalle.getValueAt(i, 1)+">"); 
  ...
  <script type="text/javascript">
        $('#tbl_pr').on('click','tr td',function(e){
            var target,idvd,idp,cantidad,precio;
            target=$(event.target);
            idvd=target.parent().data('idcd');
